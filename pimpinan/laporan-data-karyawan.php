    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Laporan Data Karyawan Bank Jelita</h1>
            </div>
            <div class="col-sm-6">
              ...
              <div class="card-body">
                ...
                <div class="card-footer" align="right">
                  <form target="_blank" method="POST"
                    action="../function/print-data-karyawan.php">
                    <button type="submit" class="btn btn-outline-success mr-1 mb-1"><i class="fas fa-print"
                        data-toggle="tooltip" data-placement="top" title="Cetak Laporan Data Karyawan"></i> Data
                      Karyawan</button>
